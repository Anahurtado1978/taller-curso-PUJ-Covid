---
title: "Curva Epidemica y Rt para COVID-19 en Bogotá"
author: "Edgar Munoz"
date: "5/23/2020"
output:
...
df.casos <- readRDS("data/Bogota.RDS")
area <- "Bogota" # keep this label short
...
kable(with(df.casos, addmargins(table(municipio))),
