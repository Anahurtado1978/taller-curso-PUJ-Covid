---
title: "20 Calcular Número Efectivo de Reproducción para Valle del Cauca"
...
plot_Rt_periodo <- plot_Rt_periodo + 
  ...
  annotate(
    ...
    geom_vline(xintercept = as.Date("2020-05-11") , linetype = "dashed", color = "red") +
  annotate(
    "text",
    label = "C. parcial",
  ...
  ggtitle("Número efectivo de reproducción (Rt), COVID-19, Valle")  
